...
switch sgd_type
    ...
    case 'adadelta'
        ...
        [p.Wi, p.pmsgWi, p.pmxgWi, p.pdWi] = adadelta(rho_hp, eps_hp, mf, p.gWi, p.pmsgWi, p.pmxgWi, p.pdWi, p.Wi);
        [p.Wfr, p.pmsgWfr, p.pmxgWfr, p.pdWfr] = adadelta(rho_hp, eps_hp, mf, p.gWfr, p.pmsgWfr, p.pmxgWfr, p.pdWfr, p.Wfr);
        [p.bh, p.pmsgbh, p.pmxgbh, p.pdbh] = adadelta(rho_hp, eps_hp, mf, p.gbh, p.pmsgbh, p.pmxgbh, p.pdbh, p.bh);
