if mod(num_up,check_valfreq) == 0
    ...
    tic
    [train_err] = compute_error(train_batchdata,train_batchtargets,train_clv,train_test_numbats,gpu_flag,p1,p2,f,nl,cfn);
    toc
    
    tic
    [val_err] = compute_error(val_batchdata,val_batchtargets,val_clv,val_numbats,gpu_flag,p1,p2,f,nl,cfn);
    toc
    ...
    if val_err < best_val_err
        ...
        tic
        [test_err] = compute_error(test_batchdata,test_batchtargets,test_clv,test_numbats,gpu_flag,p1,p2,f,nl,cfn);
        toc
