function [total_err] = compute_error(data,targets,clv,numbats,gpu_flag,GWi,GWfr,GU,GUfr,Gbh,Gbo,Ggn,Gbn,f,nl,cfn,a_tanh,b_tanh)
...
for li = 1:numbats
    ...
    % fp
    if gpu_flag
        [pacm,bacm,acm,hcm,muv,sigv,ol_mat] = fp_gpu_test(X,GWi,GWfr,GU,GUfr,Gbh,Gbo,Ggn,Gbn,f,nl,a_tanh,b_tanh,sl);
    else
