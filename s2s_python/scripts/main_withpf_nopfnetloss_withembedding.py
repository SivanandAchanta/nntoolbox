...
def train(opt):
    ...
    if opt.load_wts:
        load_model_name_pfx = '../../wt/s2s_enc_blstm_dec_lstm3l_pfnet_blstm1L_nopfnetloss__hs1250_hs2500_pfnet_hs1250_r' + str(opt.r) +'_lr0.0003_b10.9_b20.99_dp0.5_gc0.0_wtinitdefault_init_lw0_ef1_rf1_'
        load_model_name_sfx = '.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', required=False, type=str, default='s2s_enc_cbhl_dec_lstm3l_pfnet_blstm1L_nopfnetloss_', help='s2s')
