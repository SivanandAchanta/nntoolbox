...
p = []; [p_lf_2] = wt_init_lstm(p,nl(2),nl(1),si,fb_init,wtdir,wtinit_meth,sgd_type);
p = []; [p_lb_2] = wt_init_lstm(p,nl(2),nl(1),si,fb_init,wtdir,wtinit_meth,sgd_type);
p = []; [p_lf_3] = wt_init_lstm(p,nl(2),nl(1),si,fb_init,wtdir,wtinit_meth,sgd_type);
p = []; [p_lb_3] = wt_init_lstm(p,nl(2),nl(1),si,fb_init,wtdir,wtinit_meth,sgd_type);
...
% decoder
p = []; [p_lf_1_dec] = wt_init_lstm(p,nl(4),nl(end),si,fb_init,wtdir,wtinit_meth,sgd_type);
