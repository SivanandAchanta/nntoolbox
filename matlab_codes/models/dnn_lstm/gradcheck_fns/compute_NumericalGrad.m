function [gW] = compute_NumericalGrad(Wz,Rz,bz,Wi,Ri,pi,bi,Wf,Rf,pf,bf,Wo,Ro,po,bo,U,bu,W,b,...
    X,Y,f,nl,nl_dnn,f_dnn,nh_dnn,wtl_dnn,btl_dnn,nlv_dnn,sl,cfn,W_toCheck,argno,dnn_flag)
...
for cc = 1:nc
    for cr = 1:nr
        ...
        [f_xph] = compute_Fofx(X,Y,W1,W2,W3,W4,W5,W6,W7,W8,W9,W10,W11,W12,W13,W14,W15,W16,W17,W18,W19,nl,sl,f,cfn,nl_dnn,f_dnn,nh_dnn,wtl_dnn,btl_dnn,nlv_dnn,dnn_flag);
        ...
        [f_xnh] = compute_Fofx(X,Y,W1,W2,W3,W4,W5,W6,W7,W8,W9,W10,W11,W12,W13,W14,W15,W16,W17,W18,W19,nl,sl,f,cfn,nl_dnn,f_dnn,nh_dnn,wtl_dnn,btl_dnn,nlv_dnn,dnn_flag);
