function [p] = update_params_gru(p,sgd_type,lr,mf,rho_hp,eps_hp,alpha,beta1,beta2,lam,num_up)
...
switch sgd_type
    ...
    case 'sgdcm'
        ...
        [p.Wc, p.pdWc] = sgdcm(lr, mf, p.gWc, p.pdWc, p.Wc);
        [p.Rc, p.pdRc] = sgdcm(lr, mf, p.gRc, p.pdRc, p.Rc);
        [p.bc, p.pdbc] = sgdcm(lr, mf, p.gbc, p.pdbc, p.bc);
    ...
    case 'adadelta'
        ...
        [p.Wc, p.pmsgWc, p.pmsxWc, p.pdWc] = adadelta(rho_hp, eps_hp, mf, p.gWc, p.pmsgWc, p.pmsxWc, p.pdWc, p.Wc);
        [p.Rc, p.pmsgRc, p.pmsxRc, p.pdRc] = adadelta(rho_hp, eps_hp, mf, p.gRc, p.pmsgRc, p.pmsxRc, p.pdRc, p.Rc);
        [p.bc, p.pmsgbc, p.pmsxbc, p.pdbc] = adadelta(rho_hp, eps_hp, mf, p.gbc, p.pmsgbc, p.pmsxbc, p.pdbc, p.bc);
    ...
    case 'adam'
        ...
        [p.Wc,p.pmWc,p.pvWc]      = adam(alpha,beta1,beta2,eps_hp,lam,num_up,p.gWc,p.pmWc,p.pvWc,p.Wc);
        [p.Rc,p.pmRc,p.pvRc]      = adam(alpha,beta1,beta2,eps_hp,lam,num_up,p.gRc,p.pmRc,p.pvRc,p.Rc);
        [p.bc,p.pmbc,p.pvbc]      = adam(alpha,beta1,beta2,eps_hp,lam,num_up,p.gbc,p.pmbc,p.pvbc,p.bc);
