function [gWn] = compute_NumericalGrad(Wi,Wfr,bh,U,bo,X,Y,f,nl,a_tanh,b_tanh,sl,cfn,W_toCheck,argno,gpu_flag)
...
for cc = 1:nc
    for cr = 1:nr
        ...
        [f_xph] = compute_Fofx(X,Y,W1,W2,W3,W4,W5,f,nl,a_tanh,b_tanh,sl,cfn);
        ...
        [f_xnh] = compute_Fofx(X,Y,W1,W2,W3,W4,W5,f,nl,a_tanh,b_tanh,sl,cfn);
