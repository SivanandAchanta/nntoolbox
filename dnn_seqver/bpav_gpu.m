function [gW,gb] = bpav_gpu(X,Y,ol,GW,otl,btl,wtl,a_tanh,b_tanh,bby2a,fl,bs,nl,nh,cfn,l1,l2)
...
[der_f] = get_derf(nl(end),fl(end),ol_m,bs,a_tanh,b_tanh,bby2a);
...
for j = nh-1:-1:1
    ...
    [der_f] = get_derf(nl(j+1),fl(j),ol_m,bs,a_tanh,b_tanh,bby2a);
