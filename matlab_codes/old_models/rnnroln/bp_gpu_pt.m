function [gWi,gWfr,gbh,gU,gUfr,gbo] = bp_gpu(nl,f,X,Y,ol_mat,hcm,GUfr,GU,GWfr,sl,a_tanh,b_tanh,bby2a,cfn)
...
delnt = gpuArray(zeros(nl(3),1));
delm = gpuArray(zeros(sl,nl(3)));
