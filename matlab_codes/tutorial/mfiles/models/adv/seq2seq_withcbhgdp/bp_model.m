...
Ebf = p_f_3_1_N2.U'*E';
[dhm,dom,dcm,dfm,dim,dzm,Ebf] = bp_lstm(Ebf,p_lf_1_N2,zfm,ifm,ffm,cfm,ofm,hcfm,nl(11),2*sl_dec,'frnn');
[p_lf_1_N2] = gradients_lstm(hm_h_4_N2,p_lf_1_N2,hfm,cfm,dom,dfm,dim,dzm,nl(11),'frnn');

Ebb = p_f_3_2_N2.U'*E';
[dhm,dom,dcm,dfm,dim,dzm,Ebb] = bp_lstm(Ebb,p_lb_1_N2,zbm,ibm,fbm,cbm,obm,hcbm,nl(11),2*sl_dec,'brnn');
[p_lb_1_N2] = gradients_lstm(hm_h_4_N2,p_lb_1_N2,hbm,cbm,dom,dfm,dim,dzm,nl(11),'brnn');

Eb = Ebf + Ebb;
% Eb = Ebf;

[p_h_4_N2.gW,p_h_4_N2.gb,p_h_4_N2.gWt,p_h_4_N2.gbt,Eb] = bp_hl(nl(10),2*sl_dec,Eb,p_h_4_N2,htm_h_4_N2,tm_h_4_N2,hm_h_3_N2,f(9));
[p_h_3_N2.gW,p_h_3_N2.gb,p_h_3_N2.gWt,p_h_3_N2.gbt,Eb] = bp_hl(nl(10),2*sl_dec,Eb,p_h_3_N2,htm_h_3_N2,tm_h_3_N2,hm_h_2_N2,f(9));
[p_h_2_N2.gW,p_h_2_N2.gb,p_h_2_N2.gWt,p_h_2_N2.gbt,Eb] = bp_hl(nl(10),2*sl_dec,Eb,p_h_2_N2,htm_h_2_N2,tm_h_2_N2,hm_h_1_N2,f(9));
[p_h_1_N2.gW,p_h_1_N2.gb,p_h_1_N2.gWt,p_h_1_N2.gbt,Eb] = bp_hl(nl(10),2*sl_dec,Eb,p_h_1_N2,htm_h_1_N2,tm_h_1_N2,hm_c_4_N2,f(9));
...
[p_c_1_N2,Eb] = bp_clb(p_c_1_N2,Eb,hm_c_1_N2,ym_flat,K_conv_l1,C_conv_l1,nl(9),K_conv_l1*C_conv_l1,'R',2*sl_dec);
